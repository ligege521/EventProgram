...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form class="needs-validation" novalidate action="events/edit2.php?id=<?=$istr?>" method="POST">

                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        <label for="inputName">Name</label>
                        <!-- adding the class is-invalid to the input, shows the invalid feedback below -->
                        <input type="text" class="form-control is-invalid" id="inputName" placeholder="" name="name" value="<?=$arr["name"]?>">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="inputSlug" placeholder=""  name="slug" value="<?=$arr["slug"]?>">
                    </div>
                </div>
