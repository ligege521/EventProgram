            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group mr-2">
                        <a href="events/create.php?id=<?=$istr?>" class="btn btn-sm btn-outline-secondary">Create new event</a>
                    </div>
                </div>
            </div>
<?php
$sql = "select * from events where organizer_id='$istr' order by date";
            ...
            <div class="row events">
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <a href="events/detail.php?id=<?=$arr["id"]?>" class="btn text-left event">
                            <div class="card-body">
                                <h5 class="card-title"><?=$arr["name"]?></h5>
                                <p class="card-subtitle"><?=$arr["date"]?></p>
                                <hr>
